...
import jakarta.validation.Valid // Data validation and constraints dependency (see pom): spring-boot-starter-validation
...
class ContentController {
    ...
    @Autowired // it is implicit when there is only one field
